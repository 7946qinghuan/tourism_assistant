...
class Casts(BaseModel):
    ...
    def __str__(self):
        ...
        return (
            ...
            f"  🌞 白天：{self.dayweather} | 温度：{self.daytemp}℃ | 风向：{self.daywind} | 风力：{self.daypower}\n"
            f"  🌙 夜间：{self.nightweather} | 温度：{self.nighttemp}℃ | 风向：{self.nightwind} | 风力：{self.nightpower}\n"
        )
...
class WeatherForecast(BaseModel):
    ...
    def __str__(self):
        ...
        return (
            f"=========================================\n"
            f"🌤️ {self.province}{self.city} 未来4天天气预报\n"
...
class WeatherQueryToolkit(BaseToolkit):
    ...
    ) -> Union[WeatherLives, WeatherForecast]:  # 修改返回类型：支持两种模型
    ...
    def fetch_weather_from_api(
    ...
    ) -> Union[WeatherLives, WeatherForecast]:
        r"""
        ...
        Args:
            ...
            extensions (str, optional): The type of weather data to fetch.
                Defaults to "base". Options are: "base", "all".
        ...
        forecasts = True if extensions == "all" else False
        try:
    ...
    def get_tools(self) -> List[FunctionTool]:
        ...
        """
        return [
            FunctionTool(self.fetch_weather_from_api),
        ]
